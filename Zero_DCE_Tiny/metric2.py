...
ssim_value = sum(ssim_value) / len(ssim_value)
entropy_enhanced = sum(entropy_enhanced) / len(entropy_enhanced)
std_dev_enhanced = sum(std_dev_enhanced) / len(std_dev_enhanced)
mse_value = sum(mse_value) / len(mse_value)
