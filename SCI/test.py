...
parser.add_argument('--data_path', type=str, default='/home/linhhima/low_light_enhancement/SCI/data/test_image/Fake/smartphone',
                    help='location of the data corpus')
parser.add_argument('--save_path', type=str, default='/home/linhhima/low_light_enhancement/SCI/results/test_image/Fake/smartphone', help='location of the data corpus')
