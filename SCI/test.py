...
parser.add_argument('--data_path', type=str, default='/home/linhhima/low_light_enhancement/Zero-DCE++/data/test_data/real',
                    help='location of the data corpus')
parser.add_argument('--save_path', type=str, default='./results/image_from_Zero_DCE', help='location of the data corpus')
